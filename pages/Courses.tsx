  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.map(course => (
          <div key={course.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between mt-4">
                 <div className="flex items-center space-x-[-8px]">
                    <img src="https://picsum.photos/30?random=1" className="w-8 h-8 rounded-full border-2 border-white" />
                    <img src="https://picsum.photos/30?random=2" className="w-8 h-8 rounded-full border-2 border-white" />
                    <img src="https://picsum.photos/30?random=3" className="w-8 h-8 rounded-full border-2 border-white" />
                 ...
                 {enrolledIds.has(course.id) ? (
                   <span className="px-3 py-1 bg-mint-100 text-mint-700 text-sm font-medium rounded-full">Enrolled</span>
                 ) : (
                   <button 
